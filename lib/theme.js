...
const theme = {
  ...
  colors: {
    ...
    muted: colors.muted,
    svgfilter: 'invert(3%) sepia(5%) saturate(3045%) hue-rotate(161deg) brightness(103%) contrast(93%)',
    inversesvgfilter: 'invert(94%) sepia(12%) saturate(86%) hue-rotate(108deg) brightness(102%) contrast(95%)',
    ...
    modes: {
      dark: {
        ...
        muted: colors.muted,
        svgfilter: 'invert(94%) sepia(12%) saturate(86%) hue-rotate(108deg) brightness(102%) contrast(95%)',
        inversesvgfilter: 'invert(3%) sepia(5%) saturate(3045%) hue-rotate(161deg) brightness(103%) contrast(93%)',
      },
    },
  },
  fonts: {
